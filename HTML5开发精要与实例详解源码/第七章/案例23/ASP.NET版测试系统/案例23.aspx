<%@ Page Title="主页" Language="C#"  AutoEventWireup="true" CodeBehind="案例23.aspx.cs" Inherits="HTML5TEST.案例23" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<script>
    $(function () {
        ...
        $("#tbxNum").blur(function () {
            if (isNaN(parseInt($("#tbxNum").val()) * parseFloat($("#tbxPrice").val())))
                $("#tbxMoney").val("0");
            else
                $("#tbxMoney").val(Math.round(parseInt($("#tbxNum").val()) * parseFloat($("#tbxPrice").val()) * 100, 0) / 100);
        });
